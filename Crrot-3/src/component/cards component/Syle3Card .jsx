...
const Style3Card = ({ img1, title1, name1, price1, discount1 }) => {
    return (
        <div className="cards3 card p-3">
            <img className="rounded" src={img1} alt="" />
            <div className="shoping3 position-absolute rounded-circle border bg-white d-flex justify-content-center align-items-center">
