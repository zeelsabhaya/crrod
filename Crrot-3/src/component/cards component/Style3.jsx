...
import Style3Card from "./Syle3Card ";
...
const Style3 = () => {
    const data = [
        ...
        {
            img1: "https://maraviyainfotech.com/projects/carrot/carrot-v2/carrot-html/assets/img/product/4.jpg",
            title1: "Organic fresh venila farm watermelon 5kg",
            name1: "Lorem ipsum dolor adipisicing elit.",
            price1: "$120.25",
            discount1: "$123.25",
    ...
    return (
        <div className="container">
            <div className="section-products mb-5 pb-5">
                <h2 className="text-center fw-bolder">Style 3</h2>
